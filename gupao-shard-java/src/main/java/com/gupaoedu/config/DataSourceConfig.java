...
public class DataSourceConfig {
    ...
    public DataSource shardingDataSource() throws SQLException {
        ...
        src.getTableRuleConfigs().add(getDateTableRuleConfiguration());
        // 数据源名和数据源的映射表
    ...
    private Map<String, DataSource> createDataSourceMap() {
        ...
        result.put("ds0", createDataSource("jdbc:mysql://192.168.1.112:3301/ds0?characterEncoding=utf8&useSSL=false&serverTimezone=UTC"));
        result.put("ds1", createDataSource("jdbc:mysql://192.168.1.112:3301/ds1?characterEncoding=utf8&useSSL=false&serverTimezone=UTC"));
//        result.put("ds0", createDataSource("jdbc:mysql://20.18.6.97:3301/ds0?characterEncoding=utf8&useSSL=false&serverTimezone=UTC"));
//        result.put("ds1", createDataSource("jdbc:mysql://20.18.6.97:3301/ds1?characterEncoding=utf8&useSSL=false&serverTimezone=UTC"));
        return result;
    }
    ...
    // 为user_info表设置分库分表策略、算法
    public TableRuleConfiguration getDateTableRuleConfiguration() {
        TableRuleConfiguration userTableRuleConfig=new TableRuleConfiguration();
        userTableRuleConfig.setLogicTable("order_history");
        userTableRuleConfig.setKeyGeneratorColumnName("order_history_id");
        userTableRuleConfig.setActualDataNodes("ds0.order_history_201901, ds0.order_history_201902, ds0.order_history_201903");
        //userTableRuleConfig.setDatabaseShardingStrategyConfig(new StandardShardingStrategyConfiguration("month", DateDBShardAlgo.class.getName()));
        userTableRuleConfig.setTableShardingStrategyConfig(new ComplexShardingStrategyConfiguration("month1", TblComplexShardAlgo.class.getName()));
        return userTableRuleConfig;
    }
